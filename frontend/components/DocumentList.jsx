...
export default function DocumentList({ documents, onView, onDelete, loading = false }) {
  return (
    <div className="relative min-h-[200px]">
      ...
      <div
        className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 transition-opacity ${loading ? 'pointer-events-none opacity-30' : 'opacity-100'}`}
      >
        {documents.map(doc => {
